...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="#" style="margin-left:-35px;">
                <img src="{{ asset('image/LOGO-PEMKOT-BARU.png') }}" alt="Logo" class="logo-img" style="margin-right:-8px;">
                <div style="line-height:1.1;">
                    <div class="fw-bold text-dark" style="font-size:1.5rem; font-family:'Segoe UI',sans-serif;">
                        Pemerintah Kota
                    </div>
                    <div class="fw-bold text-dark" style="font-size:2rem; margin-top:-4px; font-family:'Segoe UI',sans-serif;">
                        Banjarmasin
                    </div>
                </div>
            </a>
            ...
            <div class="navbar-nav me-auto ms-4">
                <a href="#" class="nav-link text-dark fw-semibold me-4" style="font-size: 1.2rem;">Dashboard</a>
                <a href="#" class="nav-link text-dark fw-semibold" style="font-size: 1.2rem;">Lihat kuota magang</a>
            </div>
