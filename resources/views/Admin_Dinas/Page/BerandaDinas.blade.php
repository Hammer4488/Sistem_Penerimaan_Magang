...
<style>
    ...
    .stat-card-title {
        font-size: 1rem;
        font-weight: 600;
        color: #5e6e82; /* Abu-abu seperti di foto */
    }

    .stat-card-icon {
        width: 44px;
        height: 44px;
        border-radius: 0.5rem; /* Sudut ikon melengkung */
        display: flex;
        align-items: center;
...
<div class="main-content-wrapper">
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-4 col-md-6">
            <div class="stat-card">
                <div class="stat-card-header">
                    <span class="stat-card-title">Sisa Kuota</span>
                    <div class="stat-card-icon icon-bg-warning">
                        <i class="fas fa-chart-pie"></i> 
                    </div>
                </div>
                <div class="stat-card-body">
                    <h2 class="stat-card-number">{{ $sisaKuota }}</h2>
                    <div class="stat-card-subtitle">Dari total kuota: {{ $totalKuota }}</div>
                </div>
            </div>
        </div>
